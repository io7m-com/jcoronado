...
public final class GenerateFeatures12MethodNamesImmutable
{
  private GenerateFeatures12MethodNamesImmutable()
  {
  ...
  public static void main(
    final String[] args)
  {
    List.of(VulkanPhysicalDeviceFeatures12.Builder.class.getMethods())
      .stream()
      .filter(m -> Objects.equals(
        m.getDeclaringClass(),
        VulkanPhysicalDeviceFeatures12.Builder.class))
