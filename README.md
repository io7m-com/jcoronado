...
| JVM             | Platform | Status |
|-----------------|----------|--------|
| OpenJDK LTS     | Linux    | [![Build (OpenJDK LTS, Linux)](https://img.shields.io/github/workflow/status/io7m/jcoronado/main-openjdk_lts-linux)](https://github.com/io7m/jcoronado/actions?query=workflow%3Amain-openjdk_lts-linux) |
